  ...
  <div class="container-block full-fb-live">
    <div class="infos-center-v-two" style="margin:2rem 0;">
      ...
      <h3 style="" class="text-cover">
        <a href="https://clients.mindbodyonline.com/classic/ws?studioid=431828&stype=43&prodid=100069" target="_blank">Yoga illimité tout l’été pour seulement 100 $</a>.<br>Cours en studio, en plein air et en ligne.
      </h3>
      <!--
    ...
    -->
      <div class="button-group">
        <a href="https://clients.mindbodyonline.com/classic/ws?studioid=431828&stype=43&prodid=100069" target="_blank" class="button-virtuel c active">Me procurer l'Été Illimité à 100 $</a>
      </div>
    </div>
  </div>
</template>
